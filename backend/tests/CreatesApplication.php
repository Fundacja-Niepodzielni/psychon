 ...
 *
 * Runner szuka tej cechy sam; cytat (dosłowna treść, nie numery wierszy):
 ...
 *   inaczej (gałąź `Application::inferBasePath().'/bootstrap/app.php'`) ładuje
 *   `bootstrap/app.php` sam — i to samo robimy niżej,
 ...
 *   1. `RunsInParallel::forEachProcess()` (`tap($this->createApplication()`) tworzy dla
 *      KAŻDEGO tokena ŚWIEŻĄ

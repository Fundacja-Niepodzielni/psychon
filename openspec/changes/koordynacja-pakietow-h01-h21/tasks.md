...
- [x] 4.5 H09 — Wizytówki i przypisania prowadzących · Właściciel: `Tomek` · Status: `DONE` (PR #47 scalony, zakres: backend + OpenSpec; frontend w kolejnym kroku); weryfikacja: kryteria akceptacji i testy H09 przechodzą (412 backend), istnieje `DEMO/H09.md`; otwarte: K1–K12 do potwierdzenia (`DEMO/H9-prep-doc.md` §6) i frontend pakietu.
